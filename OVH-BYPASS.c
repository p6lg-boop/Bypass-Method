...
int main(int argc, char *argv[ ])
{
        if(argc < 5){
                ...
                fprintf(stderr, "p6 gimme a spoofed please im down bad i can suck your dick\n");
                exit(-1);
        }

        fprintf(stdout, "p6 gimme a spoofed please im down bad i can suck your dick BUT: Starting sockets...\n");
